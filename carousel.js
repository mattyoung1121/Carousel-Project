$(document).ready(function() {
  ...
  $(function() {
    ...
    function activeSlide() {
      if (currentSlide = 1) {
        $thumb1.css('border', '1px black solid');
      };
      if (currentSlide = 2) {
        $thumb2.css('border', '1px black solid');
      };
      if (currentSlide = 3) {
        $thumb3.css('border', '1px black solid');
      };
      if (currentSlide = 4) {
        $thumb4.css('border', '1px black solid');
      };
      if (currentSlide = 5) {
        $thumb5.css('border', '1px black solid');
      };
      if (currentSlide = 6) {
        $thumb6.css('border', '1px black solid');
      };
      if (currentSlide = 7) {
        $thumb7.css('border', '1px black solid');
      };
      if (currentSlide = 8) {
        $thumb8.css('border', '1px black solid');
      };
      if (currentSlide = 9) {
        $thumb9.css('border', '1px black solid');
      };
      if (currentSlide = 10) {
        $thumb10.css('border', '1px black solid');
      };
    };
